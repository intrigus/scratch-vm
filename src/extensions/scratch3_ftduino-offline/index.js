...
class Scratch3Offline {
	...
	addTemporaryStyleSheetToHighlightSupportedBlocks() {
		...
		g[data-id="event_whenflagclicked"] .blocklyBlockBackground,
		g[data-id="control_wait"] .blocklyBlockBackground,
		g[data-id="control_repeat"] .blocklyBlockBackground,
		g[data-id="forever"] .blocklyBlockBackground,
		g[data-id="control_if"] .blocklyBlockBackground,
		g[data-id="control_if_else"] .blocklyBlockBackground,
		g[data-id="wait_until"] .blocklyBlockBackground,
		g[data-id="repeat_until"] .blocklyBlockBackground,
		g[data-id="operator_add"] .blocklyBlockBackground,
		g[data-id="operator_subtract"] .blocklyBlockBackground,
		g[data-id="operator_multiply"] .blocklyBlockBackground,
		g[data-id="operator_divide"] .blocklyBlockBackground,
		g[data-id="operator_random"] .blocklyBlockBackground,
		g[data-id="operator_gt"] .blocklyBlockBackground,
		g[data-id="operator_lt"] .blocklyBlockBackground,
		g[data-id="operator_equals"] .blocklyBlockBackground,
		g[data-id="operator_and"] .blocklyBlockBackground,
		g[data-id="operator_or"] .blocklyBlockBackground,
		g[data-id="operator_not"] .blocklyBlockBackground,
		g[data-id="ftduino_led"] .blocklyBlockBackground,
		g[data-id="ftduino_input"] .blocklyBlockBackground,
		g[data-id="ftduino_output"] .blocklyBlockBackground,
		g[data-id="ftduino_when_input"] .blocklyBlockBackground,
		g[data-id="ftduino_input_analog"] .blocklyBlockBackground,
		g[data-id="ftduino_output_analog"] .blocklyBlockBackground,
		g[data-id="ftduino_motor"] .blocklyBlockBackground,
		g[data-id="ftduino_motor_stop"] .blocklyBlockBackground,
		g[data-id="ftduino_input_counter"] .blocklyBlockBackground,
		g[data-id="ftduino_clear_counter"] .blocklyBlockBackground {
			opacity: 100%; 
		}`;
	}
